...
static const struct ili9881c_instr ph720128t003_zbc02_init[] = {
	ILI9881C_COMMAND_INSTR(0x80, 0xb8),
	ILI9881C_COMMAND_INSTR(0x81, 0x78),
	ILI9881C_COMMAND_INSTR(0x82, 0x84),
	ILI9881C_COMMAND_INSTR(0x83, 0x88),
	ILI9881C_COMMAND_INSTR(0x84, 0xa8),
	ILI9881C_COMMAND_INSTR(0x85, 0xe3),
	ILI9881C_COMMAND_INSTR(0x86, 0x88),
	ILI9881C_COMMAND_INSTR(0xb2, 0x10),
};
